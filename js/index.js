window.addEventListener("load", function () {
	...
	const anotherSection = document.querySelector('section.another');
	...
	window.addEventListener('scroll', function () {
		...
		const sectionOffsetTop = anotherSection.offsetTop;
		const sectionHeight = anotherSection.offsetHeight;
