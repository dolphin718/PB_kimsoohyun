window.addEventListener("load", function () {
	...
	const sections = {
		...
		PROJECT: document.querySelector('.samsung'),// 1번
		ANOTHER: document.querySelector('.another'),
		SHINHAN: document.querySelector('section.shinhan'),// 2번 
		NHCARD: document.querySelector('section.nhcard'),// 3번 
		M4A: document.querySelector('section.m4a')// 4번 
	};
	...
	window.addEventListener('scroll', function () {
		...
		} else if (isInView(sections.PROJECT) || isInView(sections.SHINHAN) || isInView(sections.NHCARD) || isInView(sections.M4A)) {
